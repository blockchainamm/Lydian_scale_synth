# Program to generate the sounds of notes of a lydian scale matching the frequencies of notes in piano
...
def load_notes(notestep, notestep1, notescale):
    ...
    # Interval of notes for a lydian scale
    notes_interval = [2, 2, 2, 1, 2, 2, 1, 1]
    rev_interval = [0, 1, 2, 2, 1, 2, 2, 2]
    tones_fwd, tones_rev = [], []
    
    print(f'The frequencies in Hz of ascending notes for {notescale} in the lydian scale')
    ...
    print()
    print(f'The frequencies in Hz of descending notes for {notescale} in the lydian scale')
    ...
    # Return list of frequencies in the ascending and descending notes of the lydian scale    
...
# Scale list for which the lydian scale will be played in sequence
